...
@implementation TFBarcodeGenerateManager
+ (UIImage *)TF_generateBarcodeWithStr:(NSString *)str
                         codeImageSize:(CGSize)size
                                   red:(CGFloat)red
                                 green:(CGFloat)green
                                  blue:(CGFloat)blue {
    UIImage *image = [self TF_generateBarcodeWithStr:str codeImageSize:size];
...
+ (UIImage *)TF_generateBarcodeWithStr:(NSString *)str
                         codeImageSize:(CGSize)size{
    CIImage *image = [self TF_barcodeImageWithContent:str];
...
//生成最原始的条形码
+ (CIImage *)TF_barcodeImageWithContent:(NSString *)content{
...
+ (UIImage *)TF_generateBarcodeWithStr:(NSString *)str {
    return [UIImage imageWithCIImage:[self TF_barcodeImageWithContent:str]];
}
