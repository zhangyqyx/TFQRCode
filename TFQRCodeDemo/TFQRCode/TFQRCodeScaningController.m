...
@interface TFQRCodeScaningController ()<TFCodeScanManagerDelegate>
/** 扫描视图 */
...
@implementation TFQRCodeScaningController
- (TFCodeScanningView *)scanningView {
    if (!_scanningView) {
        ...
        _scanningView.scanningImageName = @"TFQRCode.bundle/scan_net.png";
