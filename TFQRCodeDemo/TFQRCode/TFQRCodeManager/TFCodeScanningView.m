...
#import "TFCodeScanningView.h"

@interface TFCodeScanningView ()
{
    UIView *_contentView;
    NSTimer *_timer;
...
@implementation TFCodeScanningView
...
- (void)initialization {
    _scnningType = TFScanningAnimationTypeDefault;
    _borderColor = [UIColor whiteColor];
    _cornerLocation = TFCornerLocationDefault;
    ...
    _scanningImageName = @"TFQRCode.bundle/QRCodeScanningLine.png";
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.cornerLocation == TFCornerLocationInside) {
    ...
    } else if (self.cornerLocation == TFCornerLocationOutside) {
...
- (void)addTimer {
    ...
    if (self.scnningType == TFScanningAnimationTypeGrid) {
...
- (void)setScnningType:(TFScanningAnimationType)scnningType {
...
- (void)setCornerLocation:(TFCornerLocation)cornerLocation {
